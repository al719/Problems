...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   generat_list = [x.replace(" ","_") for x in mod_list]
   return generat_list
   raise NotImplementedError()
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
#   first_letter =[employee_list[0]['name'][0],employee_list[1]['name'][0],employee_list[2]['name'][0]
#   ,employee_list[3]['name'][0],employee_list[4]['name'][0],employee_list[5]['name'][0]]
#   id=[employee_list[0]['id'],employee_list[1]['id'],employee_list[2]['id'],employee_list[3]['id']
#   ,employee_list[4]['id'],employee_list[5]['id']]
#   map_dic ={key:value for (key,value) in zip(first_letter,id)}
   map_dic={x['name'][0]:x['id'] for x in employee_list}
   return map_dic
   raise NotImplementedError()
